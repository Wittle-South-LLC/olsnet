...
export const setStatusMessage = (state, message) => state.setIn(['fetchStatus', 'message'], message)
                                                         .setIn(['fetchStatus', 'messageType'], 'status')
export const setErrorMessage = (state, message) => state.setIn(['fetchStatus', 'message'], message)
